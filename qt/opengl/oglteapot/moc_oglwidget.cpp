...
QT_MOC_LITERAL(6, 71, 12), // "setXRotation"
QT_MOC_LITERAL(7, 84, 12), // "setYRotation"
QT_MOC_LITERAL(8, 97, 12) // "setZRotation"

    },
    "OpenGLWidget\0xRotationChanged\0\0angle\0"
...
void OpenGLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::xRotationChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (OpenGLWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::yRotationChanged)) {
                *result = 1;
            }
        }
        {
            typedef void (OpenGLWidget::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&OpenGLWidget::zRotationChanged)) {
                *result = 2;
            }
        }
    }
...
// SIGNAL 0
void OpenGLWidget::xRotationChanged(int _t1)
{
...
// SIGNAL 1
void OpenGLWidget::yRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
...
// SIGNAL 2
void OpenGLWidget::zRotationChanged(int _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
